                ...
                <form>
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input id="name" type="text" value="{{ $plans->name }}">
                        </div>
                        <div class="form-group">
                            <label for="price">Plan Price</label>
                            <input id="price" type="number" value="{{ $plans->price }}">
                        </div>
                        <div class="form-group">
                            <label for="max_student">Max Student</label>
                            <input id="max_student" type="number" value="{{ $plans->max_student }}">
                        </div>
                        <div class="form-group">
                            <label for="max_program">Max Program</label>
                            <input id="max_program" type="number" value="{{ $plans->max_program }}">
                        </div>
                        <div class="form-group">
                            <label for="description">description</label>
                            <input id="description" type="text" value="{{ $plans->description }}">
                        </div>
                        <div style="text-align: center;">
                            <a type="button" onclick="performUpdate({{ $plans->id }})" class="btn btn-primary">Edit</a>
...
<script>
    function performUpdate(id){
        ...
        storeRoute('/tadreeb/plans-update/'+id , formData);
    }
</script>
